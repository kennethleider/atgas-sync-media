    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.atgas.media.beyondtv.webservices.BTVExpiration.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.atgas.media.beyondtv.webservices.BTVExpiration.class.getResource(".");
