 ...
 *         &lt;element name="bags" type="{http://www.snapstream.com/WebService}ArrayOfPVSPropertyBag" minOccurs="0"/>
 *         &lt;element name="bSaveFile" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetProfiles")
public class SetProfiles {

    protected String authTicket;
    protected ArrayOfPVSPropertyBag bags;
    protected int bSaveFile;
    ...
    /**
     * Gets the value of the bSaveFile property.
     * 
     */
    public int getBSaveFile() {
        return bSaveFile;
    }

    /**
     * Sets the value of the bSaveFile property.
     * 
     */
    public void setBSaveFile(int value) {
        this.bSaveFile = value;
    }
