 ...
 *         &lt;element name="sources" type="{http://www.snapstream.com/WebService}ArrayOfPVSPropertyBag" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SetSources")
public class SetSources {

    protected String authTicket;
    protected ArrayOfPVSPropertyBag sources;
     ...
     *     
     */
    public ArrayOfPVSPropertyBag getSources() {
        return sources;
    }
     ...
     *     
     */
    public void setSources(ArrayOfPVSPropertyBag value) {
        this.sources = value;
    }
