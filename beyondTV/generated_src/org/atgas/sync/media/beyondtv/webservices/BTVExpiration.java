    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.atgas.sync.media.beyondtv.webservices.BTVExpiration.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.atgas.sync.media.beyondtv.webservices.BTVExpiration.class.getResource(".");
            url = new URL(baseUrl, "http://localhost:8129/wsdl/BTVExpiration.asmx");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://localhost:8129/wsdl/BTVExpiration.asmx', retrying as a local file");
    ...
    public BTVExpiration() {
        super(BTVEXPIRATION_WSDL_LOCATION, new QName("http://www.snapstream.com/WebService", "BTVExpiration"));
    }
