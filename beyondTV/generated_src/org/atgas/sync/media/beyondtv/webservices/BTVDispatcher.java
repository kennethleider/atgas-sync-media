    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.atgas.sync.media.beyondtv.webservices.BTVDispatcher.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.atgas.sync.media.beyondtv.webservices.BTVDispatcher.class.getResource(".");
